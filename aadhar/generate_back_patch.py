...
qr_dir = root_dir
aadhar_output_dir = os.path.join(root_dir, "output", "back_patch")

file_suffix = "_aadhar_back_patch"
...
for image_counter in range(1, num_of_images + 1):
    ...
    for indiv_counter in range(1): #random.randint(2, 6)):
        attempts = 0
        ...
        img_w, img_h = aadhar.size
        # max_w, max_h = random.randint(round(img_w*1.5), round(img_w*2.5)), random.randint(round(img_h*1.5), round(img_h*2.5))

        max_sizes = [480, 512, 512, 640] #[1200, 1080, 900, 1440]
    ...
    #     while(True):
    #         font_random_path = "/home/arha/WorkArea/Aditya/DatasetCreation/FONTS/Calibri/Calibri.ttf"
